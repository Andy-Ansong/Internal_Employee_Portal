        ...
        <form onSubmit={(e) => {e.preventDefault();submitOtp()}} className='flex gap-[24px] flex-col'>
            <div className='flex flex-col gap-[16px]'>
                <div className='py-[10px] border-b-[1px] border-b-[#d0d5dd]'>
                    <input required value={otp} onChange={(e) => {setOtp(e.target.value)}} className='w-full outline-none border-none text-[16px] leading-[24px] font-[400] text-[#667085] [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none' type='number' placeholder='123456'/>
                </div>
            </div>
