  ...
  return (
    <div className='bg-white md:w-[440px] flex flex-col gap-[24px] h-[322px] py-[32px] px-[40px] shadow-lg'>
        ...
        <div className='flex flex-col gap-[8px]'>
            <h1 className='text-[#101828] leading-[32px] text-[20px] font-[600]'>Enter email account</h1>
        </div>
        <form onSubmit={(e) => {e.preventDefault();submitEmail()}} className='flex gap-[24px] flex-col'>
            <div className='flex flex-col gap-[16px]'>
                <div className='py-[10px] border-b-[1px] border-b-[#d0d5dd]'>
                    <input ref={inputRef} name='email' required value={email} onChange={(e) => {setEmail(e.target.value)}} className='w-full outline-none border-none text-[16px] leading-[24px] font-[400] text-[#667085]' type='email' placeholder='someone@amalitech.org'/>
                </div>
